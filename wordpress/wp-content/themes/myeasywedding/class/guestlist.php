...
*/
    ...
    //Zählschleife setzt die Klassenvariablen für Essen und Portionsgröße
...
return $ausgabe;
	...
	if((isset($_POST['update'])) && ($_POST['update'] == 'overview')){
		...
		$update = new Guestlist($user);
        $overview = array();
		
       
        
		$overview[0] = $update->gib_gaeste("GÄSTE");
        $overview[1] = $update->gib_essen("ESSEN");
